INSERT INTO vets VALUES (1, 'Daniele', 'De Marco') ON CONFLICT DO NOTHING;
INSERT INTO vets VALUES (2, 'Giacomo', 'Rossi')ON CONFLICT DO NOTHING;

INSERT INTO specialties VALUES (1, 'radiologo')ON CONFLICT DO NOTHING;
INSERT INTO specialties VALUES (2, 'TBA')ON CONFLICT DO NOTHING;
INSERT INTO specialties VALUES (3, 'dentista')ON CONFLICT DO NOTHING;
